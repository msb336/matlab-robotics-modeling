...
rprops.links = [0 0 0; 0 1 1; 0 1 4; 1 1 1.2; 1 1 4.2; 0 1 5;-5 1 4; -5 1 4.2; ...
                0 -1 1; 0 -1 4; 1 -1 1; 1 -1 4; -5 -1 4];
rprops.connections = {[0 1 9], [1 2 3 4 m], [6,7], [2,9,10,8], [9,13], [10,12,11]};
